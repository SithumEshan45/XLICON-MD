...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  '🌷𝗠𝗥.𝗦𝗜𝗧𝗛𝗨𝗠 𝗘𝗦𝗛𝗔𝗡❤️⃝™',
  packname:  process.env.PACK_NAME || '🌷𝗠𝗥.𝗦𝗜𝗧𝗛𝗨𝗠 𝗘𝗦𝗛𝗔𝗡❤️⃝™',
   
  botname:   process.env.BOT_NAME === undefined ? "⃞🌷Xlicon-```Md```" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '🌷𝗠𝗥.𝗦𝗜𝗧𝗛𝗨𝗠 𝗘𝗦𝗛𝗔𝗡❤️⃝™' : process.env.OWNER_NAME,  
